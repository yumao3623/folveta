...
export default function PrivacyPage() {
  return (
    <PublicPageLayout label="Privacy" title="How the current MVP handles study materials" asset="locked" updated="Last updated: September 1, 2026">
          <div className="public-page__prose max-w-[800px] space-y-10 border-t-2 border-[var(--border-soft)] pt-10 text-[var(--text-secondary)]">
            <section>
              <h2 className="text-2xl font-extrabold text-[var(--foreground)]">Data the product processes</h2>
            ...
            <section>
              <h2 className="text-2xl font-extrabold text-[var(--foreground)]">How it is used</h2>
            ...
            <section>
              <h2 className="text-2xl font-extrabold text-[var(--foreground)]">Storage and access</h2>
            ...
            <section>
              <h2 className="text-2xl font-extrabold text-[var(--foreground)]">Retention status</h2>
            ...
            <section>
              <h2 className="text-2xl font-extrabold text-[var(--foreground)]">Analytics and advertising</h2>
            ...
            <section>
              <h2 className="text-2xl font-extrabold text-[var(--foreground)]">Support and data requests</h2>
