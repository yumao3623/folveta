...
export default function RefundsPage() {
  return (
    <PublicPageLayout label="Refund Policy" title="Refunds and subscription cancellation" asset="heart" updated="Last updated: September 1, 2026" heroDensity="compact">
          <div className="public-page__prose max-w-[800px] space-y-10 border-t-2 border-[var(--border-soft)] pt-10 text-[var(--text-secondary)]">
            <section>
              <h2 className="text-2xl font-bold text-[var(--foreground)]">Monthly subscriptions</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--foreground)]">Cancellation refunds</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--foreground)]">When to contact us</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--foreground)]">Payment processing</h2>
