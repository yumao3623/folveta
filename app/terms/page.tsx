...
export default function TermsPage() {
  return (
    <PublicPageLayout label="Terms" title="Terms of use" asset="source" updated="Last updated: September 1, 2026" heroDensity="compact">
          <div className="public-page__prose max-w-[800px] space-y-10 border-t-2 border-[var(--border-soft)] pt-10 text-[var(--text-secondary)]">
            <section>
              <h2 className="text-2xl font-bold text-[var(--foreground)]">Use of course materials</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--foreground)]">Educational assistance, not a guarantee</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--foreground)]">Your responsibility</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--foreground)]">Service limits</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--foreground)]">Availability</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--foreground)]">Subscriptions and cancellation</h2>
