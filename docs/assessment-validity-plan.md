...
> Document status: **Historical v2 validation plan / archive candidate.** It is not a v5 launch gate. Current Quick Check boundaries remain governed by `docs/decisions.md`; current roadmap work is in `docs/v5-master-roadmap.md`.
